...
function ArticlesPage({ isAdmin }) {
  ...
  return (
    <div className="articles-page" style={{ padding: '40px', maxWidth: '1000px', margin: '0 auto' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '30px' }}>Статьи от психолога</h1>
      ...
      {(isAdding || editArticleId !== null) && (
        <form onSubmit={handleSubmit} className="article-form" style={{
          background: '#f0f0f0',
          padding: '20px',
          borderRadius: '8px',
          marginBottom: '30px'
